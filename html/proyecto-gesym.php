...
<section class="row inicio-proy">
    <div class="col-container">
        <h1>Proyecto: <b>Contadores GESYM</b></h1>
        <div class="text-centb">
            <img title="Pagina web - Gesym" src="img/proy/pant-gesym.jpg">
        </div>
    </div>
...
<section class="row pad-secc sec-desproy">
    <div class="col-container">
        ...
        <div class="cont-proy wow fadeIn">
            <p>Gesym es una compañía dedicaca a la gestión contable y tributaria, dando servición de asesoría, capacitación a empresas públicas y privadas.</p>
            <p>Nuestros clientes decidieron mostrar sus servicios en internet, para ello desarrollamos su <b>Landing Page</b> mostrarndo información sobre su empresa, información sobre su formación profesional y un formulario de contacto para consultas de sus clientes.</p>
            <p>El objetivo es captar clientes potenciales mostrando información precisa.</p>
            <a class="lik-proy linkid" href="http://www.contadoresgesym.com/" target="_blank" title="Ver landing page"><i class="fa fa-eye" aria-hidden="true"></i> Ver landing page</a>
        </div>    
        <div class="sec-share">
